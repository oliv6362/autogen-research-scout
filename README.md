...
├── environment.yml                # Defines the Conda environment used to recreate the project setup.
├── README.md
├── results/
│   └── evaluation_outputs.md      # Stores the generated evaluation results.
└── src/
    └── research_agent/
        ├── __init__.py
        ...
        ├── config.py              # Local configuration file, not committed.
        ├── tools/
        │   ├── __init__.py
